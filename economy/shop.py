...
mainshop = [{"name":"Apple","price":10,"description":"Tasty Apple"},
            {"name":"Pizza","price":30,"description":"Tasty Asf"},
            {"name":"Watch","price":100,"description":"Time"},
            {"name":"Laptop","price":1000,"description":"Work"},
            {"name":"PC","price":10000,"description":"Gaming"},
            {"name":"Ferrari","price":50000,"description":"Sports Car"},
            {"name":"Bugatti","price":75000,"description":"Top G Car"},
            {"name":"Nuclear","price":999999,"description":"Destroy Any Country You Want :)99"}]
...
async def bag(ctx):
    ...
    em = discord.Embed(title = f"{ctx.author} Bag")
    for item in bag:
        name = item["item"]
        amount = item["amount"]

        em.add_field(name = f"**{name}**", value = f"`{amount}`")    
